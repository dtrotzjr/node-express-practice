...
describe('GET /todos:id', () => {
    ...
    it('should return 404 if todo ID exists but does not belong to user', (done) => {
        const theID = todos[0]._id;
        request(app)
            .get(`/todos/${theID.toHexString()}`)
...
describe('DELETE /todos:id', () => {
    ...
    it('should return 404 if todo with ID exists but does not belong to user', (done) => {
        const theID = todos[0]._id;
        request(app)
            .delete(`/todos/${theID.toHexString()}`)
            .set('x-auth', users[1].tokens[0].token)
...
describe('PATCH /todos:id', () => {
    ...
    it('should not update and return updated todo doc for another user\'s todo', (done) => {
        const updatedText = "This has been updated";
        const theID = todos[0]._id;
        request(app)
            .patch(`/todos/${theID.toHexString()}`)
